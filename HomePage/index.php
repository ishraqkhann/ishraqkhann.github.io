...
<body>
  ...
  ?>
        ...
        <div class="row">
         ...
         <div class="row lang" style="padding-top: 12%; padding-bottom: 7%; color: white; background-color: dodgerblue; " id="serv">
             <div class="col-md-6">
         ...
         <div class="row cardss" id="service" style="background-color: dodgerblue;">
